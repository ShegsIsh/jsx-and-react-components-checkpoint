  ...
  return (
    <div className="App">
      ...
      <Card.Body style={{backgroundColor:'aqua', display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center', borderRadius:'10px'}} >
        <Card.Title style={{fontSize:'32px'}}><Name name={'T-Shirt'}/></Card.Title>
        <Card.Subtitle className="m-2 text-white"><Price price={'$40'}/></Card.Subtitle>
        <Card.Text>
        <Description/>
        </Card.Text>
        <Card.Link href="https://images.app.goo.gl/yNmBRgX9UdsGf3P58#">Image Link</Card.Link>
      </Card.Body>
    </Card>
        <Card className="m-2 w-50" style={{ borderRadius:'10px'}}>
      <Card.Body style={{backgroundColor:'aqua', display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center', borderRadius:'10px'}} >
        <Card.Title className="text-center" style={{fontSize:'32px'}}><Name name={'Sneakers'}/></Card.Title>
        <Card.Subtitle className="m-2 text-white"><Price price={'$75'}/></Card.Subtitle>
        <Card.Text>
        <Description/>
        </Card.Text>
        <Card.Link href="https://images.app.goo.gl/DxE43A7NR9oi1stx6">Image Link</Card.Link>
      </Card.Body>
    </Card>
        <Card className="m-2 w-50" style={{ borderRadius:'10px'}}>
      <Card.Body style={{backgroundColor:'aqua', display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center', borderRadius:'10px'}} >
        <Card.Title style={{fontSize:'32px'}}><Name name={'Bottle Water'}/></Card.Title>
        <Card.Subtitle className="m-2 text-white"><Price price={'$30'}/></Card.Subtitle>
        <Card.Text>
        <Description/>
        </Card.Text>
        <Card.Link href="https://images.app.goo.gl/2CGji1xWPHHKTDEu6">Image Link</Card.Link>
      </Card.Body>
    </Card>
        </section>
    </div>
